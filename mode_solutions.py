...
class mode_sol:
    ...
    def check_many(self,params:dict,neff_array:list,is_TE:list) -> dict:
        ...
        for key,array in params.items():
            ...
            if len(array.shape) == 1:
                ...
                for i,arr in enumerate(array):
                    ...
                    checked_arrays_temp.append(self.find_guided(arr,neff_array[i],is_TE[i]))
